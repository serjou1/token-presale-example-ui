...
const contractAddress = "0x4Ec49dA14f9eD644b236347201826Ac3553bcCab";
...
document.getElementById("update-price").addEventListener("click", async () => {
    ...
    const newPriceStr = document.getElementById("new-price").value;

    const tx = await contract.changePrice(ethers.parseUnits(newPriceStr, usdtDecimals));
